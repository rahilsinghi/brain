...
repo: maison-agent
community_id: 15
ingested_at: 2026-04-15T19:59:44.135Z
parsed_at: 2026-04-15T19:59:44.135Z
compiled_to: null
processed_at: null
retry_count: 2
last_error: 400 {"type":"error","error":{"type":"invalid_request_error","message":"Your credit balance is too low to access the Anthropic API. Please go to Plans & Billing to upgrade or purchase credits."},"request_id":"req_011Ca6APK49WDAb84wKHYDAF"}
compile_progress: null
quarantined_at: 2026-04-15T20:09:09.546Z
---
...
- `clients` → `api` (imports_from) [community 0]
- `clients` → `auth` (imports_from) [community 0]
- `clients` → `telemetry` (imports_from) [community 0]