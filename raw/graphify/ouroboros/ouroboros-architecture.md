...
Cohesion: 0.06
Nodes (46): load_config(), OuroborosConfig, Configuration loading and validation for Ouroboros., EvalDecision, EvaluatorAgent, Evaluator agent — runs scoreboard and makes merge/rollback decisions., Compare before/after scoreboard snapshots and decide merge or rollback., SandboxExecutor (+38 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (50): Run the meta-learning loop or display prompt version status., Show current configuration or update a configuration value., Terminal dashboard for scoreboard and ledger visualization., Render a compact summary of ledger entries., Render a scoreboard snapshot as an ASCII bar chart., render_ledger_summary(), render_scoreboard_ascii(), Enum (+42 more)
...
Cohesion: 0.04
Nodes (36): _check_bloat(), MetaAgent, MetaResult, Meta-Agent — outer loop that evolves agent prompts., Result of a meta-agent cycle., Select the agent that causes the most failures based on telemetry., Check if mutation exceeds the bloat limit., Outer loop that evolves agent prompts based on telemetry. (+28 more)
...
Cohesion: 0.07
Nodes (21): BenchmarkTask, load_benchmark_tasks(), Benchmark task definitions and rotating task generation., A single benchmark task for tournament evaluation., Load benchmark tasks from YAML files in a directory., Tests for benchmark task loading and rotating task generation., TestBenchmarkGenerator, TestBenchmarkScoring (+13 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (25): build_parser(), _cmd_benchmark(), _cmd_config(), _cmd_dashboard(), _cmd_ledger(), _cmd_meta(), _cmd_run(), _cmd_scoreboard() (+17 more)
...
Cohesion: 0.33
Nodes (4): ImplementResult, Implementer agent — writes code changes in a sandboxed worktree., Write code changes to the worktree based on the plan., _validate_files()
...
- **Thin community `Community 25`** (2 nodes): `__main__.py`, `Entry point for python -m ouroboros.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `BaseAgent` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 9`, `Community 19`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `ImprovementLoop` connect `Community 0` to `Community 1`, `Community 3`, `Community 6`, `Community 7`?**
