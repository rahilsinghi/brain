...
- `CommandBlocked` --uses--> `OuroborosConfig`  [INFERRED]
  /Users/rahilsinghi/Desktop/ouroboros/ouroboros/sandbox/executor.py → /Users/rahilsinghi/Desktop/ouroboros/ouroboros/config.py
- `ExecutionResult` --uses--> `OuroborosConfig`  [INFERRED]
  /Users/rahilsinghi/Desktop/ouroboros/ouroboros/sandbox/executor.py → /Users/rahilsinghi/Desktop/ouroboros/ouroboros/config.py
- `SandboxExecutor` --uses--> `OuroborosConfig`  [INFERRED]
  /Users/rahilsinghi/Desktop/ouroboros/ouroboros/sandbox/executor.py → /Users/rahilsinghi/Desktop/ouroboros/ouroboros/config.py
...
Cohesion: 0.06
Nodes (47): BaseAgent, load_config(), OuroborosConfig, Configuration loading and validation for Ouroboros., EvalDecision, EvaluatorAgent, Evaluator agent — runs scoreboard and makes merge/rollback decisions., Compare before/after scoreboard snapshots and decide merge or rollback. (+39 more)
...
Cohesion: 0.06
Nodes (50): MetaAgent, build_parser(), _cmd_benchmark(), _cmd_config(), _cmd_dashboard(), _cmd_ledger(), _cmd_meta(), _cmd_run() (+42 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (35): Enum, SandboxExecutor, ImplementerAgent, ImplementResult, Implementer agent — writes code changes in a sandboxed worktree., Validate Python files for syntax errors. Returns error message or empty string., Write code changes to the worktree based on the plan., _validate_files() (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (36): _check_bloat(), MetaResult, Meta-Agent — outer loop that evolves agent prompts., Result of a meta-agent cycle., Select the agent that causes the most failures based on telemetry., Check if mutation exceeds the bloat limit., Outer loop that evolves agent prompts based on telemetry., Run one meta-cycle. Returns the result. (+28 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (15): Trace analysis — pattern detection across runs., Produce aggregate statistics from trace events., TraceAnalyzer, TraceSummary, Collect trace events from claw-code CLI runs., TraceCollector, Persistent trace storage in JSONL format., test_observe_returns_report() (+7 more)
...
- **Why does `DimensionScore` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 12`, `Community 16`, `Community 18`, `Community 21`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `BaseAgent` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `ImprovementLoop` connect `Community 0` to `Community 2`, `Community 3`, `Community 6`?**
