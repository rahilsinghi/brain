---
title: Ollama Local Inference Setup on Mac Studio M3 Ultra
author: ai
created_at: 2026-04-17T02:47:20.425Z
last_ai_edit: 2026-04-17T02:47:20.425Z
last_human_edit: null
last_embedded_hash: null
sources:
  - "[[/Users/rahilsinghi/Desktop/brain/raw/conversations/ollama-local-inference-setup-2026-04-16.md]]"
tags:
  - ollama
  - mac studio
  - llm inference
...
A guide for running production LLM inference on Apple Silicon with 96GB unified memory, focusing on model selection, integration with the brain daemon, and performance benchmarks.

## Key Concepts

- Apple M3 Ultra hardware specifications
- Tiered model selection for different tasks (Qwen3 32B, Qwen3 Coder, Llama 3.3 70B)
- Model quantization and performance metrics
- Ollama provider integration with the brain daemon
- Provider fallback chain (Ollama → Gemini → Anthropic)
- Embedding model selection and performance
- Environmental variables for configuration
- Benchmark comparisons between local and cloud models
