---
title: Maison.Travel POC Architecture Meeting — April 17, 2026
author: ai
created_at: 2026-04-17T02:52:38.342Z
last_ai_edit: 2026-04-17T02:52:38.342Z
last_human_edit: null
last_embedded_hash: db38858255ae80ad
sources:
  - "[[/Users/rahilsinghi/Desktop/brain/raw/api/articles/maisontravel-poc-architecture-meeting-full-transcript-ap-1776393868248.md]]"
tags:
  - maison
  - poc
  - architecture
...
This article captures the key decisions and discussions from the Maison.Travel POC Architecture Meeting held on April 17, 2026. The meeting focused on defining the architecture, data strategy, and implementation plan for the Maison.Travel proof of concept, with a target deadline of Memorial Day (May 25, 2026) for conversational booking of East End hotels.

## Key Concepts

- Three-layer architecture (Content / MCP Tools / Payments) with Stripe integration,- Hybrid data strategy combining existing scraper and EXA for dynamic content,- Dockerized client model where each hotel is an agent with pre-hydrated knowledge base,- Schema-first design philosophy using JSON as source of truth,- Knowledge graph implementation using LanceDB for efficient context retrieval,- Operator self-service pattern for real-time content updates,- Three-tier data strategy: public web data, integrated content feeds, and operator-filled gaps
...
[[Maison.Travel POC Architecture Meeting April 17 2026]],[[Maison Workspace Hub]],[[Maison Travel AI-Native Travel App]],[[Maison Platform Architecture]],[[Bootstrap Meeting April 15 2026]],[[Preferred Hotels Integration]],[[Hermes Dockerized Client Pattern]]
